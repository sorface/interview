        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<char>(type: "TEXT", nullable: false, comment: "Available values: [Empty: E, Question: Q]"),
                    ParentQuestionSubjectTreeId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionSubjectTree_QuestionSubjectTree_ParentQuestionSubjectTreeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RootQuestionSubjectTreeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ParentQuestionTreeId = table.Column<Guid>(type: "TEXT", nullable: true),
