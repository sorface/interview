...
public class EventStorage2DatabaseServiceTest
{
    ...
    public async Task Process()
    {
        ...
        var room1 = new Room("Test 1", SERoomAcсessType.Public) { Status = SERoomStatus.Close, };
        appDbContext.Rooms.Add(room1);
        appDbContext.Rooms.Add(new Room("Test 2", SERoomAcсessType.Public) { Status = SERoomStatus.Close, });
        appDbContext.Rooms.Add(new Room("Test 3", SERoomAcсessType.Public) { Status = SERoomStatus.Close, });
        appDbContext.Rooms.Add(new Room("Test 4", SERoomAcсessType.Public) { Status = SERoomStatus.Close, });
