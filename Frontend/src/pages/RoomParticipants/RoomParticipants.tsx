...
import {
  ChangeParticipantStatusBody,
  roomParticipantApiDeclaration,
  roomsApiDeclaration,
...
export const RoomParticipants: FunctionComponent = () => {
  ...
  } = useApiMethod<object, ChangeParticipantStatusBody>(
    roomParticipantApiDeclaration.changeParticipantStatus,
  );
  const {
    process: {
      loading: changeParticipantStatusLoading,
      error: changeParticipantStatusError,
    },
      ...
      <form action="" onSubmit={handleSubmit}>
        <Field>
          ...
          <select name={userTypeFieldName}>
            <option value="Viewer">
              {localizationCaptions[LocalizationKey.Viewer]}
            </option>
            <option value="Expert">
              {localizationCaptions[LocalizationKey.Expert]}
            </option>
            <option value="Examinee">
              {localizationCaptions[LocalizationKey.Examinee]}
            </option>
          </select>
        </Field>
        ...
        {changeParticipantStatusLoading && (
          <Field>
            <div>Changing participant status...</div>
          </Field>
        )}
        {changeParticipantStatusError && (
          <Field>
            <div>
              Changing participant status error: {changeParticipantStatusError}
            </div>
          </Field>
        )}
        {changeParticipantStatusData && (
          <Field>
            <div>Successfully changed participant status</div>
          </Field>
        )}
      </form>
    );
  ...
  return <MainContentWrapper>{renderMainContent()}</MainContentWrapper>;
};
