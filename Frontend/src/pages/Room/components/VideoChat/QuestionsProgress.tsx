...
export const QuestionsProgress: FunctionComponent<QuestionsProgressProps> = ({
  ...
  return (
    <div className='relative bg-wrap' style={{ width: '18.9375rem', clipPath: 'inset(0% 0% 0% 0% round 2rem)' }}>
      <div className={`absolute h-full move-transition ${progressThemedClassName}`} style={{ width: `${value}%` }}></div>
