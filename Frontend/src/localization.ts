...
export const LocalizationCaptions: Record<LocalizationLang, Record<LocalizationKey, string>> = {
  [LocalizationLang.en]: {
    ...
    [LocalizationKey.RoomDate]: 'Meeting date',
    [LocalizationKey.RoomStartTime]: 'Meeting start time',
    [LocalizationKey.RoomEndTime]: 'Meeting end time',
  ...
  [LocalizationLang.ru]: {
    ...
    [LocalizationKey.RoomDate]: 'Дата встречи',
    [LocalizationKey.RoomStartTime]: 'Время начала встречи',
    [LocalizationKey.RoomEndTime]: 'Время окончания встречи',
    ...
    [LocalizationKey.Archive]: 'Архивировать?',
